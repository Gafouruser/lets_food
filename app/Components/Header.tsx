...
export default function Header() {
  return (
    <div className="flex items-center justify-center pt-4 pb-4 w-full h-16 bg-[#FFF9EA]">
      ...
      <div className="flex gap-16 justify-center items-center mr-24">
      ...
      <div className="flex gap-5 justify-center items-center mr-20">
        <Image src="/Images/search.png" width={20} height={20} alt="Search" />
        <Image src="/Images/buy.png" width={20} height={20} alt="Search" />
      </div>
      <a href="" className="pt-1 pl-4 pr-4 pb-1 flex gap-3 justify-center items-center bg-[#FFCB45] rounded-full">
